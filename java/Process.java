...
public class Process {
    ...
    private DoubleProperty guiRemainingTime;
    ...
    public Process(String pid, double arrivalTime, double burstTime) {
        ...
        this.guiRemainingTime = new SimpleDoubleProperty((int) burstTime);
    }
    ...
    public double getGuiRemainingTime() {
        return guiRemainingTime.get();
    }

    public DoubleProperty guiRemainingTimeProperty() {
        return guiRemainingTime;
    }

    public void setGuiRemainingTime(double guiRemainingTime) {
        this.guiRemainingTime.set(guiRemainingTime);
    }
